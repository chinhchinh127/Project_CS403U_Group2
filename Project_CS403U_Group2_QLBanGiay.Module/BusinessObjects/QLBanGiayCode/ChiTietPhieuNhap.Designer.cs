...
namespace Project_CS403U_Group2_QLBanGiay.Module.BusinessObjects.QLBanGiay
{
    ...
    public partial class ChiTietPhieuNhap : DevExpress.Persistent.BaseImpl.BaseObject
    {
        PhieuNhap fPhieuNhap_ID;
        [Association(@"ChiTietPhieuNhapReferencesPhieuNhap")]
        ...
        HangHoa fHangHoa_ID;
        [Association(@"ChiTietPhieuNhapReferencesHangHoa")]
