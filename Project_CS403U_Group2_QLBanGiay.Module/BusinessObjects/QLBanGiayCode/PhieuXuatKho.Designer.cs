...
namespace Project_CS403U_Group2_QLBanGiay.Module.BusinessObjects.QLBanGiay
{
    ...
    public partial class PhieuXuatKho : DevExpress.Persistent.BaseImpl.BaseObject
    {
        Kho fPhieuXuatKho_ID;
        public Kho PhieuXuatKho_ID
        {
            get { return fPhieuXuatKho_ID; }
            set { SetPropertyValue<Kho>(nameof(PhieuXuatKho_ID), ref fPhieuXuatKho_ID, value); }
        }
        string fNhanVien_ID;
...
DevExpress.ExpressApp.Model.ModelDefault("DisplayFormat", "{0:dd/MM/yyyy HH:mm}")]
        ...
        [Association(@"ChiTietPhieuXuatKhoReferencesPhieuXuatKho"), Aggregated]
